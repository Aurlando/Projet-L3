...
export default function LieuDetail({ navigation, route }) {
    ...
    if (!lieu) {
        return (
            <View style={styles.center}>
                <Text style={styles.errorText}>Lieu introuvable</Text>
            </View>
        );
    }
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.identityCard}>
                            <View style={styles.identityItem}>
                                ...
                                <Text style={styles.identityLabel}>Espèces Clés</Text>
                            </View>
                            <Text style={styles.identityText}>{details.identity.keySpecies}</Text>
                        </View>
                    </View>
                )}
                ...
                {details.didYouKnow && (
                    <View style={styles.section}>
                        <View style={styles.didYouKnowHeader}>
                            ...
                            <Text style={styles.didYouKnowTitle}>{details.didYouKnow.title}</Text>
                        </View>
                        <Image 
                            source={details.didYouKnow.image} 
                            style={styles.didYouKnowImage}
                            resizeMode="cover"
                        />
                        <Text style={styles.didYouKnowText}>{details.didYouKnow.text}</Text>
                    </View>
                )}
